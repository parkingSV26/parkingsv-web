...
import type { Parking, ParkingReview, SpanishDay } from "@/app/parqueos/parking-data";
import styles from "./parking-detail.module.css";

type ActiveModal = "capacity" | "google" | "location" | "schedule" | "share" | "waze" | null;
...
export default function ParkingDetailClient({
  ...
  function handleReserveAction() {
    showNotification("Reserva registrada correctamente.", "success");
  }
  ...
  function handleReviewSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const nextReview: ParkingReview = {
      id: `demo-review-${Date.now()}`,
      author: sessionUser?.fullName ?? "Usuario Parking SV",
      avatar: sessionUser?.profilePicture ?? "/parkingsv/default-avatar.jpeg",
      rating: reviewRating,
...
function getOrderedDays(): SpanishDay[] {
  return ["lunes", "martes", "miercoles", "jueves", "viernes", "sabado", "domingo"];
}

function formatScheduleForDay(parking: Parking, day: SpanishDay) {
